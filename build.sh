...
# PPA 1
#sudo chroot $HOME/ubuntu-custom/chroot add-apt-repository -yn ppa:usuário/programa
# PPA 2
#sudo chroot $HOME/ubuntu-custom/chroot add-apt-repository -y ppa:usuário/programa
# Apt repo
#echo 'deb https://domínio.com/programa ./ main' | sudo tee $HOME/ubuntu-custom/chroot/etc/apt/sources.list.d/programa.list
#wget -O- https://domínio.com/program/programa.key | gpg --dearmor | sudo tee $HOME/ubuntu-custom/chroot/etc/apt/trusted.gpg.d/programa.gpg
